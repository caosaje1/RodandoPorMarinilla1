...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Log.d("user"username);
        Log.d("login",String.valueOf())*/

        if (prefs.getInt("login",-1) == 1) {  // 1 hay alguien loggeado -1 no lo hay
        ...
        bIniciar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (eUsername.getText().toString().equals("") && ePassword.getText().toString().equals("")) {
                    Toast.makeText(getApplicationContext(), "Debe digitar usuario y contraseña", Toast.LENGTH_SHORT).show();
                } else {
